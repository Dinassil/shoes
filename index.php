...
<body>
    ...
    <div class="navbar-collapse collapse w-100 order-3 dual-collapse2 justify-contend-end">
        <ul class="navbar-nav ml-auto" style="float:right;">
            <li class="nav-item">
                <a class="nav-link" href="cart_index3.php">Корзина</a>
            </li>
            <li class="nav-item">
...
<br />		
			<?php
				$query = "SELECT * FROM table46 ORDER BY id ASC";
